...
int main()
{
    cout << "Testing Adding Functionality!" << endl;
    Sorted_Set<int> temp_set;
    cout << "Adding 2, 1, 1, 3 to the Set!" << endl;
    temp_set.__insert_val__(2);
    temp_set.__insert_val__(1);
    temp_set.__insert_val__(1);
    temp_set.__insert_val__(3);
    cout << "Printing the Set!" << endl;
    temp_set.__print__();
    cout << "Deleting at 2 Index! Index starts from 0!" << endl;
    temp_set.__delete_val__(2);
    cout << "Printing the Set!" << endl;
    temp_set.__print__();
    cout << endl;
    cout << "Testing Union Functionality!" << endl;
    cout << endl;
    Sorted_Set<int> set_a;
    set_a.__insert_val__(1);
    set_a.__insert_val__(2);
    set_a.__insert_val__(3);
    set_a.__insert_val__(4);
    set_a.__insert_val__(10);
    set_a.__insert_val__(50);
    cout << "Set A: ";
    set_a.__print__();
    Sorted_Set<int> set_b;
    set_b.__insert_val__(6);
    set_b.__insert_val__(10);
    set_b.__insert_val__(11);
    cout << "Set B: ";
    set_b.__print__();
    set_a.__union__(set_b);
    cout << "Set A Union B: ";
    set_a.__print__();
